...
<body style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 650px; margin: 0 auto; padding:5px;">
  <div style="background: linear-gradient(135deg, #ff4d4d, #cc0000); padding: 5px; text-align: center; border-radius: 8px 8px 0 0;">
  ...
  <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 8px 8px; box-shadow: 0 3px 10px rgba(0,0,0,0.1); border: 1px solid #f0f0f0;">
    ...
    <div style="text-align: center; margin: 35px 0;">
      <span style="font-size: 36px; font-weight: bold; letter-spacing: 8px; color: #cc0000; background-color: #fff5f5; padding: 15px 30px; border-radius: 6px; border: 2px dashed #ffcccc;">{verificationCode}</span>
    </div>
    ...
    <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #f0f0f0;">
      <p style="color: #444; margin: 0;">Best regards,<br><span style="color: #cc0000; font-weight: 500;">NetWit,Canada</span></p>
    </div>
  </div>
...
<body style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #ff4d4d, #cc0000); padding: 25px; text-align: center; border-radius: 8px 8px 0 0;">
  ...
  <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 8px 8px; box-shadow: 0 3px 10px rgba(0,0,0,0.1); border: 1px solid #f0f0f0;">
    ...
    <div style="text-align: center; margin: 35px 0;">
      <div style="background-color: #cc0000; color: white; width: 60px; height: 60px; line-height: 60px; border-radius: 50%; display: inline-block; font-size: 30px; box-shadow: 0 3px 6px rgba(204,0,0,0.2);">
        ✓
      </div>
    </div>
    <div style="background-color: #fff5f5; padding: 20px; border-radius: 6px; margin: 25px 0;">
...
<body style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 8px 8px; box-shadow: 0 3px 10px rgba(0,0,0,0.1); border: 1px solid #f0f0f0;">
    ...
    <div style="text-align: center; margin: 35px 0;">
      <a href="{resetURL}" style="background: linear-gradient(135deg, #ff4d4d, #cc0000); color: white; padding: 14px 30px; text-decoration: none; border-radius: 6px; font-weight: 500; letter-spacing: 0.5px; display: inline-block; box-shadow: 0 3px 6px rgba(204,0,0,0.2);">Reset Password</a>
    </div>
